...
function processGPTBatches(startRowGPT, endRowGPT, inColGPT, outColGPT) {
    ...
    const outputRange = `${outColGPT}${startRowGPT}:${outColGPT}${(startRowGPT + results.length - 1)}`;
   ...
   * @param {string} outColGPT The column letter where the results should be written.
   */
  function startGPTProcessing(startRowGPT=3, endRowGPT=3587, inColGPT="AO", outColGPT="AP") {
